   ...
   public void subtract(Place place, int number) {
      ...
      switch (place) {
         ...
         case END:
            ...
            break;
         case RANDOM:
            Node node = get(Selector.randomIntegerFromRange(0, size() - 1));//Losowanie indeksu i pobieranie węzła
   ...
   public void add(Place place, int number) {
      ...
      switch (place) {
         ...
         case RANDOM: {
            int i = 0;
             if (size != 1) {
                 i = Selector.randomIntegerFromRange(0, size() - 1);//Jeżeli tablica ma więcej niż jeden element, wylosuj miejsce wstawienia
             }
